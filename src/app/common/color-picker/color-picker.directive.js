System.register(['@angular/core', './color-picker.service', './classes'], function(exports_1, context_1) {
    "use strict";
    ...
    var styleUrls, templateUrl, ColorPickerDirective, TextDirective, SliderDirective, DialogComponent;
    return {
        setters:[
            function (core_1_1) {
                core_1 = core_1_1;
